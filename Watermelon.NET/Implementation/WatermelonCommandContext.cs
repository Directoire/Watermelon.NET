...
{
    public class WatermelonCommandContext : Qmmands.CommandContext
    {
        /// <summary>
        ...
        public WatermelonCommandContext(IServiceProvider serviceProvider, DiscordMessage message, string prefix)
            : base(serviceProvider)
        {
            var bot = serviceProvider.GetRequiredService<Watermelon>();
